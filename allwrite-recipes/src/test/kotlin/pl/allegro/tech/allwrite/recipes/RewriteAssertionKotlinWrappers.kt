...
fun properties(before: String, after: String?, spec: SourceSpec<Properties.File>.() -> Unit = {}) = properties(before, after, spec)

fun yaml(beforeAndAfter: String, spec: SourceSpec<Yaml.Documents>.() -> Unit = {}) = yaml(beforeAndAfter, spec)

fun yaml(before: String, after: String?, spec: SourceSpec<Yaml.Documents>.() -> Unit = {}) = yaml(before, after, spec)

fun java(before: String, after: String?, spec: SourceSpec<CompilationUnit>.() -> Unit = {}) = java(before, after, spec)

fun java(beforeAndAfter: String, spec: SourceSpec<CompilationUnit>.() -> Unit = {}) = java(beforeAndAfter, spec)

fun kotlin(before: String, after: String, spec: SourceSpec<KotlinCompilationUnit>.() -> Unit = {}) = kotlin(before, after, spec)

fun kotlin(beforeAndAfter: String, spec: SourceSpec<KotlinCompilationUnit>.() -> Unit = {}) = kotlin(beforeAndAfter, spec)

fun groovy(before: String, after: String?, spec: SourceSpec<GroovyCompilationUnit>.() -> Unit = {}) = groovy(before, after, spec)

fun groovy(beforeAndAfter: String, spec: SourceSpec<GroovyCompilationUnit>.() -> Unit = {}) = groovy(beforeAndAfter, spec)

fun text(before: String, after: String?, spec: SourceSpec<PlainText>.() -> Unit = {}) = text(before, after, spec)
