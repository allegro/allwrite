...
public class RemoveUnusedLocalVariables extends Recipe {
    ...
    String[] onlyRemoveVariablesOfType;
    Boolean ignorePossibleSideEffects;

    public RemoveUnusedLocalVariables() {
    }

    public RemoveUnusedLocalVariables(String[] ignoreVariablesNamed, String[] onlyRemoveVariablesOfType, Boolean ignorePossibleSideEffects) {
        this.ignoreVariablesNamed = ignoreVariablesNamed;
        this.onlyRemoveVariablesOfType = onlyRemoveVariablesOfType;
        this.ignorePossibleSideEffects = ignorePossibleSideEffects;
    }
    ...
    @Nullable
    public void setIgnoreVariablesNamed(@Nullable String[] ignoreVariablesNamed) {
        this.ignoreVariablesNamed = ignoreVariablesNamed;
    }

    public String[] getIgnoreVariablesNamed() {
        return ignoreVariablesNamed;
    }

    public String[] getOnlyRemoveVariablesOfType() {
        return onlyRemoveVariablesOfType;
    }

    public void setOnlyRemoveVariablesOfType(String[] onlyRemoveVariablesOfType) {
        this.onlyRemoveVariablesOfType = onlyRemoveVariablesOfType;
    }

    @Option
    public void setIgnorePossibleSideEffects(Boolean ignorePossibleSideEffects) {
        this.ignorePossibleSideEffects = ignorePossibleSideEffects;
    }

    public Boolean getIgnorePossibleSideEffects() {
        return ignorePossibleSideEffects;
    }
    ...
    public @NotNull TreeVisitor<?, ExecutionContext> getVisitor() {
        ...
        Set<String> ignoreVariableNames = Optional.ofNullable(ignoreVariablesNamed)
            .map(it -> new HashSet<>(Arrays.asList(it)))
            .orElse(null);

        Set<String> removeVariableTypes = Optional.ofNullable(onlyRemoveVariablesOfType)
            .map(it -> new HashSet<>(Arrays.asList(it)))
            .orElse(null);
        ...
        return new JavaIsoVisitor<>() {
            ...
            @Override
            public J.VariableDeclarations.@NotNull NamedVariable visitVariable(J.VariableDeclarations.@NotNull NamedVariable variable, @NotNull ExecutionContext ctx) {
                ...
                if (variable.getType() instanceof JavaType.FullyQualified &&
                    removeVariableTypes != null &&
                    !removeVariableTypes.contains(((JavaType.FullyQualified) variable.getType()).getFullyQualifiedName())
                ) {
                    return variable;
                }
                ...
                if (parentScope.getParent() == null ||
                    ...
                    (!ignorePossibleSideEffects && initializerMightSideEffect(variable))
                ) {
                    return variable;
                }
