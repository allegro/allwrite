...
internal fun J.MethodDeclaration.hasAutowiredAnnotation() =
    leadingAnnotations
 ...
 */
internal fun J.MethodDeclaration.findArguments(qualifiedName: String): List<Variable> =
    parameters.filterIsInstance<J.VariableDeclarations>()
        .mapNotNull {
