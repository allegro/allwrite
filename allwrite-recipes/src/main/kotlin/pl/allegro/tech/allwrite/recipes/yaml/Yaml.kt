...
internal object Builders {
    fun mapping(entries: List<Yaml.Mapping.Entry>) = Yaml.Mapping(
        Tree.randomId(),
        Markers.EMPTY,
        null,
        entries,
    ...
    fun entry(key: YamlKey, value: Yaml.Block, prefix: String = "") = Yaml.Mapping.Entry(
        Tree.randomId(),
        prefix,
        Markers.EMPTY,
        key,
    ...
    fun scalar(value: String) = Yaml.Scalar(
        Tree.randomId(),
        "",
        Markers.EMPTY,
