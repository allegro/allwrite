...
internal fun assignment(name: String, expr: Expression): J.Assignment = J.Assignment(
    Tree.randomId(), Space.EMPTY, Markers.EMPTY, J.Identifier(
        Tree.randomId(),
        Space.EMPTY,
        Markers.EMPTY,
        ...
        null
    ), JLeftPadded.build(expr).withBefore(Space.SINGLE_SPACE), expr.type
)
