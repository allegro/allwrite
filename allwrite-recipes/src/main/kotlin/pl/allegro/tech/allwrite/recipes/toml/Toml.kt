...
internal object Builders {
    fun KeyValue(
        ...
        value: Toml,
    ): Toml.KeyValue = Toml.KeyValue(id, prefix, markers, key as TomlRightPadded<TomlKey>, value)
