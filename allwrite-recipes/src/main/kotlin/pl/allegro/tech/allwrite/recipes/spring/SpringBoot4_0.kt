...
public class SpringBoot4_0 : IsolatedSpringRecipe(from = "3.5", to = "4.0") {
    ...
    private fun upgradeGroovyToV5(): List<ChangeGradleDependency> = listOf(
    ...
    private fun relocateTestClientTypes(): List<Recipe> = listOf(
        ChangeType(
    ...
    private fun addTestClientDependencies(): List<Recipe> = listOf(
        ...
        PreconditionsAwareAddDependency(
            ...
            detectedTypes = listOf("org.springframework.boot.test.web.client.TestRestTemplate"),
            configuration = "testImplementation",
            groupId = "org.springframework.boot",
        ...
        PreconditionsAwareAddDependency(
            ...
            detectedDependencies = listOf("io.rest-assured:rest-assured"),
            configuration = "testImplementation",
