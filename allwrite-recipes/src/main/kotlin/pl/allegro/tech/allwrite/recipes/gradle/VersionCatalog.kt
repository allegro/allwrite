...
public data class Library(val group: String, val name: String, val version: Version?)
public data class Plugin(val id: String, val version: Version?)

public sealed interface Version
public data class VersionRef(val ref: String) : Version
public data class PlainVersion(val version: String) : Version
...
internal fun Library.toTomlEntry(entryName: String) = buildMap {
