...
internal class OpenrewriteRecipeSource(
    private val externalRecipeJarsProvider: ExternalRecipeJarsProvider
) : RecipeSource {
    ...
    private fun buildExternalEnvironment(): Environment? {
        val jarPaths = externalRecipeJarsProvider.getJarPaths()
        ...
        jarPaths.forEach { jarPath ->
            logger.info { "Scanning external recipe JAR: $jarPath" }
