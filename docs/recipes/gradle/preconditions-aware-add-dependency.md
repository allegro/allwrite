...
Configure at least one of `requiredTypes` or `requiredDependencies`. Omitted, `null`, or empty `requiredClasspath` and `requiredTypes` values disable their respective conditions.
