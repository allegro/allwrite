...
internal class AddExternalRecipeCommand(
...
) : SubCommand(name = COMMAND_NAME, help = "Adds an external recipe JAR from a URL") {

    private val name: String by argument(help = "Name for the external recipe source")
    private val url: String by argument(help = "URL of the recipe JAR to download")
    ...
    override fun runSubCommand(): ExecutionResult {
        ...
        echo("Added external recipe '$name' from $url")
