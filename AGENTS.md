...
│   │   │   ├── AddSettingsPluginRepository.kt  Add gated repositories to Gradle settings files
...
│   │   │   └── RemoveTomlVersionCatalogLibrary.kt  Remove a library from a TOML version catalog
